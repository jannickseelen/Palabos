...
struct ThreadAttribution {
    ...
    virtual bool isLocal(int blockId) const =0;
    ...
    virtual int getMpiProcess(int blockId) const =0;
    /// Specifies to which of the local shared-memory threads the blockId
    ///   belongs.
    virtual int getLocalThreadId(int blockId) const =0;
...
struct SerialThreadAttribution : public ThreadAttribution {
    virtual bool isLocal(int blockId) const;
    virtual bool allBlocksAreLocal() const;
    virtual int getMpiProcess(int blockId) const;
    virtual int getLocalThreadId(int blockId) const;
    virtual ThreadAttribution* merge (
              ThreadAttribution const& rhs,
...
public:
    ...
    void addBlock(int blockId, plint mpiProcess, plint localThread=0);
    virtual bool isLocal(int blockId) const;
    virtual bool allBlocksAreLocal() const;
    virtual int getMpiProcess(int blockId) const;
    virtual int getLocalThreadId(int blockId) const;
