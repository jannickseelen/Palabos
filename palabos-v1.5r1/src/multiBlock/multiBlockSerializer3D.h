...
private:
    ...
    void computeBufferAlongX(plint nextBlockId, int nextChunkSize) const;
    void computeBufferAlongY(plint nextBlockId, int nextChunkSize) const;
    void computeBufferAlongZ(plint nextBlockId, int nextChunkSize) const;
    void communicateBuffer(int bufferSize, plint fromBlockId, bool isAllocated) const;
...
private:
    SparseBlockStructure3D const& getSparseBlockStructure() const;
    bool isLocal(plint blockId) const;
    void fillBufferAlongX(plint nextBlockId, int nextChunkSize);
    void fillBufferAlongY(plint nextBlockId, int nextChunkSize);
    void fillBufferAlongZ(plint nextBlockId, int nextChunkSize);
    void communicateBuffer(int bufferSize, plint toBlockId, bool isAllocated) const;
private:
