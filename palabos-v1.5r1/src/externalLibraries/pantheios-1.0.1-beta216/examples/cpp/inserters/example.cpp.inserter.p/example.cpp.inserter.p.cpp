/* /////////////////////////////////////////////////////////////////////////
 * File:        examples/cpp/inserters/example.cpp.inserter.p/example.cpp.inserter.p.cpp
 *
...
#include <pantheios/inserters/p.hpp>          // for pantheios::p
 ...
 * fe.N, fe.simple, etc. */
PANTHEIOS_EXTERN_C const PAN_CHAR_T PANTHEIOS_FE_PROCESS_IDENTITY[] = PANTHEIOS_LITERAL_STRING("example.cpp.inserter.p");
...
int main()
{
  try
  {
    ...
    pantheios::log_NOTICE(PSTR("pv: ["), pantheios::p(pv, 0), PSTR("]"));

    // Log a pointer into 8 spaces, right justified; Output: "pv: [  12fed0]"

    pantheios::log_NOTICE(PSTR("pv: ["), pantheios::p(pv, 8), PSTR("]"));

    // Log a pointer into 8 spaces, left justified; Output: "pv: [12fed0  ]"

    pantheios::log_NOTICE(PSTR("pv: ["), pantheios::p(pv, -8, pantheios::fmt::hex), PSTR("]"));

    // Log a pointer of precise length with 0x prefix; Output: "pv: [0x12fed0]"

    pantheios::log_NOTICE(PSTR("pv: ["), pantheios::p(pv, 0, pantheios::fmt::zeroXPrefix), PSTR("]"));

    // Log a pointer into 8 spaces, right justified, with 0x prefix; Output: "pv: [  0x12fed0]"

    pantheios::log_NOTICE(PSTR("pv: ["), pantheios::p(pv, 8, pantheios::fmt::zeroXPrefix), PSTR("]"));
    ...
    pantheios::log_NOTICE(PSTR("pv: ["), pantheios::p(pv, 8, pantheios::fmt::zeroPad | pantheios::fmt::zeroXPrefix), PSTR("]"));

    // Log a pointer of precise length with 0x prefix, a length of 8, and zero-padded; Output: "pv: [0x000000000012fed0]"

    pantheios::log_NOTICE(PSTR("pv: ["), pantheios::p(pv, 16, pantheios::fmt::fullHex), PSTR("]"));
